    ...
    <header className="sticky top-0 z-50 h-20 border-b border-[var(--color-line)] bg-[var(--color-paper)]/95 backdrop-blur-md">
      <div className="mx-auto flex h-full max-w-[1200px] items-center justify-between px-6 md:px-8">
        ...
        <Link
          ...
          aria-label="AOA Global Services Inicio"
        >
          <motion.div
        ...
        <motion.button
          ...
          className="flex h-10 w-10 items-center justify-center text-[var(--color-ink)] md:hidden focus-visible:outline-[var(--color-navy)] cursor-pointer"
      ...
      {/* Mobile Drawer (Full-screen solid Navy with Framer Motion AnimatePresence) */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
