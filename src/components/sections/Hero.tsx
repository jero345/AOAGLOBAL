        ...
        <div className="grid min-h-[75vh] items-center gap-12 md:grid-cols-[55fr_45fr] lg:gap-16">
          ...
          >
            <motion.div variants={itemVariants}>
              <Eyebrow tone="navy">
                Consultoría Estratégica & Operaciones Globales
              </Eyebrow>
            </motion.div>
            ...
            >
              Transformamos complejidad operativa en ventaja competitiva.
            </motion.h1>
            ...
            >
              Asesoramos a comités de dirección y líderes empresariales en el diseño, estructuración y despliegue de modelos operativos de alto rendimiento, optimización de capital y gobernanza corporativa.
            </motion.p>
            ...
            <TiltCard maxTilt={6}>
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[var(--radius-card)] border border-[var(--color-line)] bg-[var(--color-line)] group shadow-sm transition-shadow duration-300 hover:shadow-md">
                <motion.img
                  ...
                  alt="Arquitectura corporativa global que representa solidez estratégica y gobernanza"
                ...
                >
                  ...
                  <p className="text-sm font-medium mt-1 text-white">
                    Soluciones estructuradas para corporaciones en América y Europa.
                  </p>
                </motion.div>
              </div>
            </TiltCard>
