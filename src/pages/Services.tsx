...
export const Services: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Servicios | AOA Global Services</title>
        <meta
          name="description"
          content="Conozca nuestras 6 áreas de especialidad en consultoría estratégica, optimización de procesos, transformación digital y gobernanza corporativa."
        />
        ...
        <div className="mx-auto max-w-[1200px] px-6 md:px-8">
          ...
          >
            ...
            <h1 className="text-3xl font-bold tracking-tight text-[var(--color-ink)] sm:text-4xl md:text-5xl">
              Servicios de Consultoría de Alta Dirección
            </h1>
            <p className="mt-4 text-base text-[var(--color-slate)] md:text-lg leading-relaxed">
              Combinamos metodología rigurosa, análisis cuantitativo y experiencia sectorial para resolver los desafíos operacionales más complejos de su organización.
            </p>
          </motion.div>
        </div>
      </section>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-slate-50/80 p-6 rounded-[var(--radius-card)] border border-[var(--color-line)] mt-4">
                        <h3 className="text-xs font-bold uppercase tracking-[0.08em] text-[var(--color-navy)] mb-3">
                          Entregables y Alcance del Mandato
                        </h3>
